...
<div class = "blue">
Throughout recent past years, the popularity of the makeup industry has skyrocketed. This most likely occurred with the rise of social media and social media personalities, from YouTube, Instagram, to even TikTok. While this might seem great, one side that is not acknowledged much is the exclusivity that comes with it. In fact, many people with darker complexions have an extremely difficult time finding their perfect foundation shade, and this is a huge disservice to communities of color. 
...
```{r, fig.cap="**Figure 3** Scatterplot of Lightness and Price (numerical variables), colored by Best Seller (categorical variable)." }
...
```{r, fig.cap="**Figure 4a** Parallel slopes model plot comparing lightness (x-axis) to price in dollars (y-axis). India is acting as the baseline (main y-intercept of comparison). Plot compares price and lightness of foundations across four different countries." }
...
```{r, fig.cap="**Figure 4b** Parallel slopes model graph with white background to better view data  points"}
...
```{r, fig.cap="**Figure 5** Interaction model linearity plot comparing lightness (x-axis) to price in dollars (y-axis). India is acting as the baseline (main slope of comparison). Plot compares price and lightness of foundations across four different countries. We did not  choose this model."}
ggplot(makeup_shades, aes(lightness, price, col = best_seller))+
...
```{r constant variance plot, fig.cap= "**Figure 6a** Residuals versus fitted values plot. Dotted line represents where residuals equal 0."}
...
```{r residuals1, fig.cap="**Figure 6b** Histogram of the residuals"}
...
```{r, qq plot, fig.cap="**Figure 6c** qqplot of the residuals"}
