...
```{r, fig.cap="Parallel slopes model plot comparing lightness (x-axis) to price in dollars(y-axis). India is acting as the baseline (main y-intercept of comparison). Plot compares price and lightness of foundations across four different countries." }
