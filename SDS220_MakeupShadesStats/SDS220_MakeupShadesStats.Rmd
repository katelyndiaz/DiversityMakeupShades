...
> Data is right-skewed. Range of price is from approximately $1 to $70. 
...
> Data is left-skewed. Range of lightness is from approximately 0-100 (from darkest to lightest)
...
> US has the highest number of brands contributing to this dataset, with over 150
...
```{r constant variance plot, fig.cap= "**Figure 7a** Residuals versus fitted values plot. Dotted line represents where residuals equal 0."}
...
#### qqplot
```{r, qq plot, fig.cap="**Figure 7c** qqplot of the residuals"}
