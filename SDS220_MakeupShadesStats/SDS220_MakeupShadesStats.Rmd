...
```{r, fig.cap="**Figure 1** Parallel slopes model plot comparing lightness (x-axis) to price in dollars (y-axis). India is acting as the baseline (main y-intercept of comparison). Plot compares price and lightness of foundations across four different countries." }
...
```{r, fig.cap="Parallel slopes model graph with white background to better view data  points"}
ggplot(makeup_shades, aes(lightness, price, col = best_seller)) +
  scale_x_continuous(breaks=c(0,20,40,60,80,100))+
  theme_minimal(base_size=20)+ 
  labs(title="Parallel Slopes Model of Makeup Data",
