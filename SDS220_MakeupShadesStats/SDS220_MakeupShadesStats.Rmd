...
```{r, fig.cap="**Figure 2** Interaction model linearity plot comparing lightness (x-axis) to price in dollars (y-axis). India is acting as the baseline (main slope of comparison). Plot compares price and lightness of foundations across four different countries."}
ggplot(makeup_shades, aes(lightness, price, col = best_seller))+
...
Because we found little association between our two variables: `lightness` and `price`, we would like to determine if there is an association between other variables in the dataset, such as 
</div>
